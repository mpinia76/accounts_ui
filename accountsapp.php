...
//session_set_cookie_params(0, "accounts_ui" );
session_start ();
...
/*
ob_start();
system('java -jar /home/bernardo/workspacejee/accounts-proxy/bin/accounts-proxy.jar', $retval);
$factory = trim(ob_get_contents());
ob_clean();
*/
AccountsUISetup::initialize($appname);
