...
namespace Accounts\UI\components\boxes\banco;
...
class BancoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		if( !empty($banco )){
			...
			$xtpl->assign("saldo",  AccountsUIUtils::formatMontoToView($banco->getSaldo()) );
			$xtpl->assign("saldoInicial",  AccountsUIUtils::formatMontoToView($banco->getSaldoInicial()) );
