...
use Accounts\UI\components\grid\formats\GridImporteFormat;

use Accounts\UI\components\grid\formats\GridEstadoGastoFormat;
...
//		//TODO esto setearlo en el .rasty
	...
	public function getRowStyleClass($item){
		...
		//return AccountsUIUtils::getEstadoGastoCss($item->getEstado());
	...
	public function getHeaderContent(){
		...
		return 'Total: '.AccountsUIUtils::formatMontoToView($service->getTotales($filter->getCriteria()));
	}
