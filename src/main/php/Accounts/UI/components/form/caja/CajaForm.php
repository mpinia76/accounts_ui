...
namespace Accounts\UI\components\form\caja;

use Accounts\UI\service\finder\SucursalFinder;

use Accounts\UI\service\finder\EmpleadoFinder;

use Accounts\UI\components\filter\model\UIEmpleadoCriteria;

use Accounts\UI\components\filter\model\UISucursalCriteria;
...
//		}
	...
	public function getFechaEditable(){
		return AccountsUIUtils::isAdminLogged();
	}
