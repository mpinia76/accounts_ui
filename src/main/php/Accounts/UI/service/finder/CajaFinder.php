<?php
namespace Accounts\UI\service\finder;

use Accounts\UI\utils\AccountsUIUtils;

use Accounts\UI\components\filter\model\UICajaCriteria;
...
class CajaFinder implements  IAutocompleteFinder {
	...
	function getEntityLabel( $entity ){
		...
		if( !empty( $entity)  ){
			...
			$params = array( $entity->getNumero(), $entity->getCajero(), AccountsUIUtils::formatMontoToView($entity->getSaldo()) );
			return AccountsUIUtils::formatMessage( $msg, $params);
		}
