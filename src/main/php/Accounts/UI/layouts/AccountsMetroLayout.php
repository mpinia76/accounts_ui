...
class AccountsMetroLayout extends RastyLayout{
	...
	public function getContent(){
		...
		$xtpl = $this->getXTemplate( dirname(__DIR__) . "/layouts/AccountsMetroLayout.htm" );
...
// 		$this->addStyle( "$webPath/metro/less/metro-bootstrap.less");
       ...
       // $this->addStyle( "$webPath/assets/css/style.css");
